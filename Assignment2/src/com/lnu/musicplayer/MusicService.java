...
import com.lnu.Mp3MainActivity;
import com.lnu.R;
 ...
 * Intents (which come from our main activity, {@link Mp3MainActivity}, which
...
public class MusicService extends Service implements OnCompletionListener,
	...
	final static String TAG = "Mp3MusicPlayer";
	...
	// our service in
	// AndroidManifest.xml.
	public static final String ACTION_TOGGLE_PLAYBACK = "com.lnu.musicplayer.action.TOGGLE_PLAYBACK";
	public static final String ACTION_PLAY = "com.lnu.musicplayer.action.PLAY";
	public static final String ACTION_PAUSE = "com.lnu.musicplayer.action.PAUSE";
	public static final String ACTION_STOP = "com.lnu.musicplayer.action.STOP";
	public static final String ACTION_NEXT = "com.lnu.musicplayer.action.SKIP";
	public static final String ACTION_PREV = "com.lnu.musicplayer.action.REWIND";
	// public static final String ACTION_URL =
	// "com.lnu.musicplayer.action.URL";
	...
	private void processTogglePlaybackRequest() throws IOException {
	...
	private void processPlayRequest() throws IOException {
		...
		if (mState == State.Stopped) {
			...
			// playing
			MusicRetriever.Item playItem = mRetriever.getCurrItem();
			playSong(playItem);
	...
	void processPrevRequest() throws IOException {
		if (mState == State.Retrieving) {
			// If we are still retrieving media, just set the flag to start
			// playing when we're
			// ready
			mRetriever.selectPrevSong();
			mStartPlayingAfterRetrieve = true;
			return;
		}
	 ...
	 * @throws IOException
	 */
	private void playNextOrPrevSong(boolean isPrevious) throws IOException {
		mState = State.Stopped;
	...
	private void playSong(MusicRetriever.Item playingItem) throws IOException {
		if (playingItem == null) {
			Toast.makeText(
					this,
	...
	private void updateNotification(String text) {
		PendingIntent pi = PendingIntent.getActivity(getApplicationContext(),
				0, new Intent(getApplicationContext(), Mp3MainActivity.class),
				PendingIntent.FLAG_UPDATE_CURRENT);
		mNotification.setLatestEventInfo(getApplicationContext(),
				"Mp3MusicPlayer", text, pi);
