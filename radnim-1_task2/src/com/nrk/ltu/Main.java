...
public class Main extends ListActivity {
	...
	private class MyArrayAdapter extends ArrayAdapter<TagedImage> {
		...
		public MyArrayAdapter(Context context, int resource, int textViewResourceId, List<TagedImage> objects) {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			Bitmap b = CommonUtils.getBitmap(getContentResolver(), tagedImageList.get(position).imageUrl);
			iv.setImageBitmap(b);
			tv.setText(CommonUtils.getContactName(row.getContext(), tagedImageList.get(position).contactUrl));
			return row;
		}
